...
import { faTrash, faSignOutAlt, faEdit, faFileUpload, faSpinner } from '@fortawesome/free-solid-svg-icons'
...
library.add(faTrash, faSignOutAlt, faEdit, faFileUpload, faSpinner)
